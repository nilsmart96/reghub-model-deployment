        ...
        if input5 == "EU":
            ...
            if len(ema_output) == 1:
                if ema_output[0] == '1':
                    ...
                    # Logic for finding the right chapter
                    st.write("Please check the following chapters of the EMA Regulation for further information:")
                    st.write("1) B.I.d.1)4)")
                    st.write("2) B.I.d.1)2)")
                    st.write("3) B.I.c")
                elif ema_output[0] == '0':
